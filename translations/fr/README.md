...
6. Passez directement au [Chapitre 2 : Provisionner Azure AI Foundry](./02-SetupDevEnvironment/README.md#step-2-provision-azure-ai-foundry)
...
- **Écosystème Java AI** : Présentation des SDK Spring AI et OpenAI
- **Protocole de Contexte de Modèle** : Introduction au MCP et son rôle dans la communication des agents IA
- **Applications Pratiques** : Scénarios réels incluant chatbots et création de contenu
- **[→ Démarrer Chapitre 1](./01-IntroToGenAI/README.md)**

### **Chapitre 2 : Configuration de l’Environnement de Développement**
- **Azure AI Foundry** : Provisionnez les déploiements de modèles en tant que code avec Bicep et l’Azure Developer CLI (azd)
- **Spring Boot + Spring AI** : Meilleures pratiques pour le développement d’applications IA d’entreprise
- **Authentification Sans Clé** : Connexion sécurisée avec Microsoft Entra ID — pas de gestion de clés API
- **Outils de Développement** : Conteneurs Docker, VS Code, et configuration GitHub Codespaces
- **[→ Démarrer Chapitre 2](./02-SetupDevEnvironment/README.md)**

### **Chapitre 3 : Techniques de Base de l’IA Générative**
...
- **[→ Démarrer Chapitre 3](./03-CoreGenerativeAITechniques/README.md)**

### **Chapitre 4 : Applications Pratiques & Projets**
- **Générateur d’Histoire pour Animaux** (`petstory/`) : Création de contenu créatif avec Azure AI Foundry
- **Démonstration Locale Foundry** (`foundrylocal/`) : Intégration locale de modèles IA avec OpenAI Java SDK
- **Service Calculateur MCP** (`calculator/`) : Implémentation basique du Protocole de Contexte de Modèle avec Spring AI
- **[→ Démarrer Chapitre 4](./04-PracticalSamples/README.md)**

### **Chapitre 5 : Développement Responsable de l’IA**
- **Sécurité de Contenu Azure AI Foundry** : Testez les mécanismes de filtrage et sécurité intégrés (blocages stricts et refus souples)
- **Démonstration d’IA Responsable** : Exemple pratique montrant le fonctionnement des systèmes modernes de sécurité IA
- **Bonnes Pratiques** : Directives essentielles pour le développement et déploiement éthiques de l’IA
- **[→ Démarrer Chapitre 5](./05-ResponsibleGenAI/README.md)**
...
Si vous êtes bloqué ou avez des questions sur la création d’applications IA, rejoignez d’autres apprenants et développeurs expérimentés pour discuter du MCP. C’est une communauté bienveillante où les questions sont les bienvenues et où le savoir est partagé librement.

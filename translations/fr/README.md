...
**Engagement temporel** : L'atelier complet peut être réalisé en ligne sans configuration locale. La mise en place de l'environnement prend 2 minutes, l'exploration des exemples nécessite 1 à 3 heures selon la profondeur d'exploration.
...
4. Cliquez sur **Créer le codespace**
...
- **Concepts fondamentaux** : Comprendre les grands modèles de langage, les tokens, les embeddings et les capacités de l'IA
...
- **Azure AI Foundry** : Provisionnez les déploiements de modèles en tant que code avec Bicep et Azure Developer CLI (azd)
- **Spring Boot + Spring AI** : Meilleures pratiques pour le développement d'applications IA en entreprise
- **Authentification sans clé** : Connectez-vous en toute sécurité avec Microsoft Entra ID — pas de gestion de clés API
...
### **Chapitre 3 : Techniques principales de l'IA générative**
- **Ingénierie de prompt** : Techniques pour des réponses optimales des modèles IA
...
- **Appel de fonctions** : Étendez les capacités de l'IA avec des outils personnalisés et plugins
- **[→ Commencer le Chapitre 3](./03-CoreGenerativeAITechniques/README.md)**

### **Chapitre 4 : Applications pratiques & projets**
- **Générateur d'histoires d'animaux** (`petstory/`) : Génération créative de contenu avec Azure AI Foundry
- **Demo Foundry locale** (`foundrylocal/`) : Intégration locale de modèles IA avec OpenAI Java SDK
...
### **Chapitre 5 : Développement IA responsable**
- **Sécurité de contenu Azure AI Foundry** : Testez le filtrage de contenu intégré et les mécanismes de sécurité (blocages durs et refus doux)
- **Démonstration IA responsable** : Exemple pratique montrant comment fonctionnent les systèmes modernes de sécurité IA
- **Bonnes pratiques** : Les lignes directrices essentielles pour un développement et un déploiement éthiques de l'IA
...
### Série Copilot
[![Copilot pour Programmation en Binôme avec IA](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Si vous êtes bloqué ou avez des questions sur la création d'applications IA. Rejoignez d'autres apprenants et développeurs expérimentés dans des discussions sur MCP. C'est une communauté accueillante où les questions sont les bienvenues et les connaissances sont partagées librement.

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

Si vous avez des retours sur le produit ou des erreurs pendant la création, visitez :

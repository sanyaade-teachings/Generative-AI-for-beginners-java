...
2. Кликнете върху **Code** → раздела **Codespaces** → **...** → **New with options...**
...
5. Изчакайте около 2 минути, докато средата е готова
6. Минайте директно към [Глава 2: Provision Azure AI Foundry](./02-SetupDevEnvironment/README.md#step-2-provision-azure-ai-foundry)
...
- **Демонстрация на Foundry Local** (`foundrylocal/`): Локална интеграция на AI модел с OpenAI Java SDK
- **MCP услуга калкулатор** (`calculator/`): Основна имплементация на Model Context Protocol със Spring AI

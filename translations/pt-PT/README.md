...
**Compromisso de Tempo**: O workshop completo pode ser concluído online sem configuração local. A configuração do ambiente leva 2 minutos, com a exploração dos exemplos a requerer de 1 a 3 horas, dependendo da profundidade da exploração.

> **Início Rápido**

1. Faça um fork deste repositório para a sua conta GitHub
2. Clique em **Code** → separador **Codespaces** → **...** → **New with options...**
3. Use as predefinições – isso selecionará o contentor de desenvolvimento criado para este curso
4. Clique em **Create codespace**
5. Aguarde ~2 minutos até o ambiente estar pronto
6. Vá diretamente para [Capítulo 2: Provisionar Azure AI Foundry](./02-SetupDevEnvironment/README.md#step-2-provision-azure-ai-foundry)
...
> ```
>
> Isso fornece tudo o que precisa para completar o curso com um download muito mais rápido.
...
- **Ecossistema IA Java**: Visão geral dos SDKs Spring AI e OpenAI
...
- **Azure AI Foundry**: Provisionar implementações de modelos como código com Bicep e Azure Developer CLI (azd)
- **Spring Boot + Spring AI**: Melhores práticas para desenvolvimento empresarial de aplicações IA
- **Autenticação Sem Chave**: Conecte-se de forma segura com Microsoft Entra ID — sem chaves API para gerir
...
- **Engenharia de Prompt**: Técnicas para respostas ótimas de modelos IA
...
- **Chamada de Funções**: Expanda capacidades IA com ferramentas personalizadas e plugins
...
- **Demo Foundry Local** (`foundrylocal/`): Integração local de modelos IA com OpenAI Java SDK
...
- **Segurança de Conteúdo Azure AI Foundry**: Testar filtros de conteúdo incorporados e mecanismos de segurança (bloqueios rígidos e recusas suaves)
- **Demo de IA Responsável**: Exemplo prático mostrando o funcionamento dos sistemas modernos de segurança IA
...
[![Web Dev para Iniciantes](https://img.shields.io/badge/Web%20Dev%20for%20Beginners-EC4899?style=for-the-badge&labelColor=E5E7EB&color=EC4899)](https://aka.ms/webdev-beginners?WT.mc_id=academic-105485-koreyst)
...
Se ficar bloqueado ou tiver alguma questão sobre como construir aplicações de IA, junte-se a outros aprendizes e desenvolvedores experientes nas discussões sobre MCP. É uma comunidade de apoio onde as perguntas são bem-vindas e o conhecimento é partilhado livremente.

...
**Komitmen Waktu**: Seluruh workshop dapat diselesaikan secara daring tanpa pengaturan lokal. Pengaturan lingkungan memerlukan 2 menit, dengan eksplorasi contoh membutuhkan 1-3 jam tergantung kedalaman eksplorasi.
...
6. Langsung menuju [Contoh pertama](./02-SetupDevEnvironment/README.md#step-2-create-a-github-personal-access-token)
...
> ```
>
> Ini memberikan Anda semua yang dibutuhkan untuk menyelesaikan kursus dengan unduhan yang jauh lebih cepat.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

## Struktur Kursus & Jalur Pembelajaran

### **Bab 1: Pengenalan Generative AI**
- **Konsep Dasar**: Memahami Large Language Models, token, embeddings, dan kemampuan AI
...
- **Azure AI Foundry**: Menyediakan penyebaran model sebagai kode dengan Bicep dan Azure Developer CLI (azd)
- **Spring Boot + Spring AI**: Praktik terbaik untuk pengembangan aplikasi AI perusahaan
- **Autentikasi Tanpa Kunci**: Terhubung dengan aman menggunakan Microsoft Entra ID — tanpa mengelola kunci API
...
- **Keamanan Konten Azure AI Foundry**: Uji penyaringan konten bawaan dan mekanisme keamanan (blok keras dan penolakan lembut)
- **Demo AI Bertanggung Jawab**: Contoh praktis menunjukkan bagaimana sistem keamanan AI modern bekerja
...
Jika Anda mengalami kendala atau memiliki pertanyaan tentang membangun aplikasi AI. Bergabunglah dengan sesama pelajar dan pengembang berpengalaman dalam diskusi tentang MCP. Ini adalah komunitas yang mendukung di mana pertanyaan diterima dan pengetahuan dibagikan secara bebas.

...
**Tidsforbrug**: Hele workshoppen kan gennemføres online uden lokal opsætning. Miljøopsætningen tager 2 minutter, mens udforskningen af eksemplerne kræver 1-3 timer afhængigt af udforskningsdybden.

> **Hurtig Start** 

1. Fork dette repository til din GitHub-konto
2. Klik **Code** → **Codespaces** fanen → **...** → **Ny med valgmuligheder...**
...
- **Kernebegreber**: Forståelse af Store Sprogsmodeller, tokens, embeddings og AI-evner
...
- **Praktiske Anvendelser**: Virkelighedsscenarier inklusiv chatbots og indholdsgenerering
- **[→ Start Kapitel 1](./01-IntroToGenAI/README.md)**

### **Kapitel 2: Opsætning af Udviklingsmiljø**
- **Azure AI Foundry**: Provisioner modelimplementeringer som kode med Bicep og Azure Developer CLI (azd)
- **Spring Boot + Spring AI**: Best practice for erhvervs AI-applikationsudvikling
- **Nøglefri Autentifikation**: Forbind sikkert med Microsoft Entra ID — ingen API-nøgler at administrere
...
- **Function Calling**: Udvid AI-evner med brugerdefinerede værktøjer og plugins
...
- **Best Practice**: Vigtige retningslinjer for etisk AI-udvikling og implementering

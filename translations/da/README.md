...
**Tidsforpligtelse**: Hele workshoppen kan gennemføres online uden lokal opsætning. Miljøopsætningen tager 2 minutter, mens udforskning af eksemplerne kræver 1-3 timer afhængigt af udforskningsdybde.
...
5. Vent cirka 2 minutter, til miljøet er klar
6. Gå direkte til [Kapitel 2: Provision Azure AI Foundry](./02-SetupDevEnvironment/README.md#step-2-provision-azure-ai-foundry)
...
>
> Dette repository inkluderer mere end 50 sprogoversættelser, hvilket øger downloadstørrelsen betydeligt. For at clone uden oversættelser, brug sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
- **Kernebegreber**: Forståelse af Store Sprogsmodeller, tokens, embeddings og AI-kapaciteter
- **Java AI Økosystem**: Oversigt over Spring AI og OpenAI SDKs
- **Model Context Protocol**: Introduktion til MCP og dens rolle i AI agent kommunikation
...
- **Azure AI Foundry**: Provisioner modeludrulninger som kode med Bicep og Azure Developer CLI (azd)
- **Spring Boot + Spring AI**: Bedste praksis for enterprise AI-udvikling
- **Keyless Authentication**: Sikker forbindelse med Microsoft Entra ID — ingen API-nøgler at håndtere
...
- **Embeddings & Vector Operations**: Implementer semantisk søgning og lighedsmatch
...
- **Pet Story Generator** (`petstory/`): Kreativ indholdsgenerering med Azure AI Foundry
...
- **Azure AI Foundry Content Safety**: Test indbyggede indholdsfiltrerings- og sikkerhedsmekanismer (hårde blokeringer og bløde afvisninger)
- **Responsible AI Demo**: Hands-on eksempel der viser, hvordan moderne AI sikkerhedssystemer fungerer i praksis

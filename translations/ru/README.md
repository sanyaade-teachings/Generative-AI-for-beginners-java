...
![Генеративный ИИ для начинающих - выпуск для Java](../../translated_images/ru/beg-genai-series.8b48be9951cc574c.webp)
...
6. Перейдите прямо к [главе 2: Развертывание Azure AI Foundry](./02-SetupDevEnvironment/README.md#step-2-provision-azure-ai-foundry)
